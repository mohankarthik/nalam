...
COPY data/units.json data/drugs.json data/ignored_analytes.json data/specialties.json data/conditions.json data/conditions_ignore.json data/icd10_categories.json ./data/
